      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="w-full max-w-lg">
            ...
            <p className="md:text-md">
              Unlock the potential of effective coaching and mentoring.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <div>
            ...
            <p>
              Explore how active listening transforms coaching effectiveness and
          ...
          <div>
            ...
            <p>
              Learn how trust enhances the mentoring experience for both parties
              involved.
            </p>
            <div className="mt-6 flex items-center">
              <div className="mr-4 shrink-0">
          ...
          <div>
            ...
            <a href="#" className="mb-2 block max-w-full">
              <h5 className="text-xl font-bold md:text-2xl">
                Non-Verbal Cues in Coaching
              </h5>
            </a>
            <p>
              Discover the impact of body language on effective coaching
              sessions.
            </p>
            <div className="mt-6 flex items-center">
              <div className="mr-4 shrink-0">

        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <Card className="flex size-full flex-col items-center justify-start">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>
                Discover how digital marketing is evolving and what it means for
                your business.
              </p>
              <Button
                title="Read more"
          ...
          <Card className="flex size-full flex-col items-center justify-start">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>
                Learn the essential steps to create a strong brand identity.
              </p>
              <Button
                title="Read more"
                variant="link"
          ...
          <Card className="flex size-full flex-col items-center justify-start">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>
                Unlock the secrets to successful content marketing and audience
                engagement.
              </p>
              <Button
                title="Read more"

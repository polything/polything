        ...
        <div className="flex flex-col items-center">
          <div className="rb-12 mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
            ...
            <p className="md:text-md">
              At Polything, we follow a structured approach to develop effective
              marketing strategies. From initial consultation to execution, we
              ensure every step is tailored to your unique business needs.
            </p>
          </div>
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            ...
            <div className="flex w-full flex-col items-center text-center">
              ...
              <p>
                Our team crafts a customized marketing strategy tailored to your
                objectives.
              </p>
            </div>
            <div className="flex w-full flex-col items-center text-center">
              ...
              <p>
                We execute the strategy with precision, ensuring alignment with
                your brand.
              </p>
            </div>
          </div>

      ...
      <div className="container">
        <div className="mb-12 w-full md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Polything transformed our marketing approach significantly.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-x-8 lg:gap-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md leading-[1.4] font-bold md:text-xl">
              "Working with Polything was a game changer for us. Their insights
              and strategies helped us achieve our goals faster than we
              anticipated."
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md leading-[1.4] font-bold md:text-xl">
              "The team at Polything truly understands our needs. Their tailored
              strategies made a remarkable difference in our outreach efforts."
            </blockquote>
            <div className="mt-6 flex w-full flex-col gap-3 md:mt-8 md:w-auto md:flex-row md:items-center md:gap-5">
              <div>
                <img
              ...
              <div className="mb-4 md:mb-0">
                ...
                <p>Marketing Director, Bluefort Security</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
                <img

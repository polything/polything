        ...
        <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-[1fr_20rem] lg:gap-x-16 xxl:gap-x-48">
          <div className="max-w-lg">
            <div className="md:prose-md prose lg:prose-lg">
              <Fragment>
                <h2 id="heading-2">Finding Consultant</h2>
                <p>
                  <strong>
                ...
                <h3 id="heading-3">Evaluating Consultants</h3>
                <p>
                ...
                <h4 id="heading-4">Productive Relationship</h4>
                <p>

        ...
        <div className="mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
          ...
          <div>
            <p className="mb-6 md:mb-8 md:text-md">
              Our brand audit provides you with actionable insights tailored to
              your business needs. Discover strengths, weaknesses, and
            ...
            <div className="grid grid-cols-1 gap-6 py-2 sm:grid-cols-2">
              <div>
                ...
                <p>
                  Receive tailored recommendations from our experienced brand
                  consultants.
                </p>
              </div>
              <div>
                ...
                <p>
                  Understand your market position and how to improve it
                  effectively.
                </p>
              </div>
            </div>
